...
| exoplatform/ci:jdk11                |   11.0.2    | 2.7 & 3  | 4.8 | n/a            | [goss.yaml](jdk/jdk11/tests/goss.yaml)
...
| exoplatform/ci:jdk11-maven32        |   11.0.2    | 2.7 & 3  | 4.8 | Maven 3.2.5    | [goss.yaml](maven/jdk11-maven32/tests/goss.yaml)
| exoplatform/ci:jdk11-maven33        |   11.0.2    | 2.7 & 3  | 4.8 | Maven 3.3.9    | [goss.yaml](maven/jdk11-maven33/tests/goss.yaml)
| exoplatform/ci:jdk11-maven35        |   11.0.2    | 2.7 & 3  | 4.8 | Maven 3.5.4    | [goss.yaml](maven/jdk11-maven35/tests/goss.yaml)
| exoplatform/ci:jdk11-maven36        |   11.0.2    | 2.7 & 3  | 4.8 | Maven 3.6.3    | [goss.yaml](maven/jdk11-maven36/tests/goss.yaml)
